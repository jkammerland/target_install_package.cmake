...
- Archive ownership controls apply to every CPack Archive format and its Cygwin/FreeBSD derivatives. Encoding and restoration depend on the format and extraction tool; non-archive generators ignore the controls.
