...
function(
  ...
  string(TOLOWER "${_tip_appimage_metadata_extension}" _tip_appimage_metadata_extension)
  if(kind STREQUAL "DESKTOP")
    if(NOT _tip_appimage_metadata_extension STREQUAL ".desktop")
      project_log(FATAL_ERROR "${argument_name} must have a .desktop extension, got: ${_tip_appimage_metadata_name}")
    endif()
  elseif(
    ...
    project_log(FATAL_ERROR "${argument_name} must have a .png, .svg, or .xpm extension, got: ${_tip_appimage_metadata_name}")
  endif()
...
function(_tip_validate_appimage_desktop_file desktop_path icon_name)
  ...
  string(FIND "${icon_name}" "${_tip_appimage_desktop_icon}" _tip_appimage_icon_prefix_index)
  if(NOT _tip_appimage_icon_prefix_index EQUAL 0)
    project_log(FATAL_ERROR "APPIMAGE_DESKTOP_FILE Icon '${_tip_appimage_desktop_icon}' must prefix-match APPIMAGE_ICON_FILE basename '${icon_name}'.")
  endif()
