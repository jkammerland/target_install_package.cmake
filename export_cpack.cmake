...
function(_tip_validate_appimage_desktop_file desktop_path icon_name)
  ...
  get_filename_component(_tip_appimage_icon_stem "${icon_name}" NAME_WE)
  if(NOT _tip_appimage_desktop_icon STREQUAL _tip_appimage_icon_stem)
    project_log(FATAL_ERROR "APPIMAGE_DESKTOP_FILE Icon '${_tip_appimage_desktop_icon}' must exactly match APPIMAGE_ICON_FILE basename without extension '${_tip_appimage_icon_stem}'.")
  endif()
