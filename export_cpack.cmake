...
function(_execute_deferred_cpack_config)
  ...
  if(_tip_additional_cpack_vars_seen)
    ...
    if(_tip_additional_cpack_var_remainder EQUAL 0)
      ...
      while(_tip_additional_cpack_var_index LESS _tip_additional_cpack_var_count)
        ...
        if(_tip_additional_cpack_var_name STREQUAL "CPACK_SOURCE_GENERATOR")
  ...
  set(_tip_has_effective_deb_generator ${_tip_has_deb_generator})
  ...
  set(_tip_all_generators_upper ${_tip_generators_upper} ${_tip_source_generators_upper})
  ...
  if(_tip_compression_level_explicit)
    ...
    if(_tip_has_effective_archive_generator AND NOT _tip_archive_compression_level_explicit AND _tip_archive_max_compression_level EQUAL 9)
      set(_tip_generic_max_compression_level 9)
    endif()
    if(_tip_has_effective_deb_generator AND NOT _tip_debian_compression_level_explicit AND _tip_debian_max_compression_level EQUAL 9)
      set(_tip_generic_max_compression_level 9)
    endif()
