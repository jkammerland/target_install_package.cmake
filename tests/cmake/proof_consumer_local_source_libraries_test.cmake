...
set(_tip_case_root "${TIP_PROOF_TEST_ROOT}/consumer-local-source-libraries")
...
file(
  ...
  "target_sources(object_source INTERFACE FILE_SET implementation TYPE SOURCES BASE_DIRS \"\${CMAKE_CURRENT_SOURCE_DIR}/src\" FILES \"\${CMAKE_CURRENT_SOURCE_DIR}/src/object.cpp\")\n"
  "target_install_package(object_source EXPORT_NAME proof_consumer_source_pkg NAMESPACE proof:: VERSION 1.0.0 SOURCE_LIBRARY_TYPE OBJECT SOURCE_LIBRARY_ALIAS rebuilt_object)\n"
