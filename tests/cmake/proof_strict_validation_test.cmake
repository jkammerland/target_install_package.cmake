...
set(_tip_case_root "${TIP_PROOF_TEST_ROOT}/sv")
# Keep generated fixture paths short enough for Windows compiler probes.
set(_tip_collision_source_dir "${_tip_case_root}/cfg-coll-src")
set(_tip_collision_build_dir "${_tip_case_root}/cfg-coll-bld")
set(_tip_cross_call_collision_source_dir "${_tip_case_root}/cfg-cross-src")
set(_tip_cross_call_collision_build_dir "${_tip_case_root}/cfg-cross-bld")
set(_tip_equivalent_output_collision_source_dir "${_tip_case_root}/cfg-equiv-src")
set(_tip_equivalent_output_collision_build_dir "${_tip_case_root}/cfg-equiv-bld")
set(_tip_trailing_output_collision_source_dir "${_tip_case_root}/cfg-trail-src")
set(_tip_trailing_output_collision_build_dir "${_tip_case_root}/cfg-trail-bld")
set(_tip_same_source_cross_call_source_dir "${_tip_case_root}/cfg-same-src")
set(_tip_same_source_cross_call_build_dir "${_tip_case_root}/cfg-same-bld")
set(_tip_notfound_source_cross_call_source_dir "${_tip_case_root}/cfg-nfsrc-src")
set(_tip_notfound_source_cross_call_build_dir "${_tip_case_root}/cfg-nfsrc-bld")
set(_tip_notfound_output_source_dir "${_tip_case_root}/cfg-nfout-src")
set(_tip_notfound_output_build_dir "${_tip_case_root}/cfg-nfout-bld")
set(_tip_relative_output_source_dir "${_tip_case_root}/cfg-rel-src")
set(_tip_relative_output_build_dir "${_tip_case_root}/cfg-rel-bld")
set(_tip_duplicate_source_source_dir "${_tip_case_root}/cfg-dupsrc-src")
set(_tip_duplicate_source_build_dir "${_tip_case_root}/cfg-dupsrc-bld")
set(_tip_missing_template_source_dir "${_tip_case_root}/missing-tpl-src")
set(_tip_missing_template_build_dir "${_tip_case_root}/missing-tpl-bld")
set(_tip_missing_additional_source_dir "${_tip_case_root}/missing-add-src")
set(_tip_missing_additional_build_dir "${_tip_case_root}/missing-add-bld")
set(_tip_component_only_source_dir "${_tip_case_root}/component-src")
set(_tip_component_only_build_dir "${_tip_case_root}/component-bld")
set(_tip_late_target_source_dir "${_tip_case_root}/late-target-src")
set(_tip_late_target_build_dir "${_tip_case_root}/late-target-bld")
set(_tip_odd_cpack_source_dir "${_tip_case_root}/odd-cpack-src")
set(_tip_odd_cpack_build_dir "${_tip_case_root}/odd-cpack-bld")
set(_tip_empty_cpack_source_dir "${_tip_case_root}/empty-cpack-src")
set(_tip_empty_cpack_build_dir "${_tip_case_root}/empty-cpack-bld")
set(_tip_list_cpack_source_dir "${_tip_case_root}/list-cpack-src")
set(_tip_list_cpack_build_dir "${_tip_case_root}/list-cpack-bld")
