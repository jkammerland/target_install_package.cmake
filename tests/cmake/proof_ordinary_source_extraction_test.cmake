...
file(
  ...
  "target_install_package(ordinary_source_only EXPORT_NAME ordinary_source_pkg NAMESPACE ordinary:: VERSION 1.0.0 SOURCE_FILE_SET_FROM_TARGET_SOURCES implementation SOURCE_FILE_SET_PROPERTIES implementation SKIP_LINTING ON)\n"
...
file(
  ...
  "endif()\n"
  "get_property(skip_lint FILE_SET implementation TARGET ordinary::ordinary_source_only PROPERTY SKIP_LINTING)\n"
  "if(NOT skip_lint)\n"
  "  message(FATAL_ERROR \"Missing SKIP_LINTING on extracted source file set\")\n"
  "endif()\n"
