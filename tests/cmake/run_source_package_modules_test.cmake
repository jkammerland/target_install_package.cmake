...
get_target_property(_source_math_modules_interface_sources SourceMathModules::source_math_modules INTERFACE_SOURCES)
if(NOT _source_math_modules_interface_sources)
  message(FATAL_ERROR "SourceMathModules::source_math_modules did not expose INTERFACE_SOURCES")
endif()
file(WRITE "${CMAKE_BINARY_DIR}/source_math_modules_interface_sources.txt" "${_source_math_modules_interface_sources}\n")
...
set(_consumer_interface_sources "${_consumer_build_dir}/source_math_modules_interface_sources.txt")
_tip_assert_file_contains("${_consumer_interface_sources}" "${_installed_source}")
_tip_assert_file_not_contains("${_consumer_interface_sources}" "${_fixture_source_dir}/src/source_math.cpp")
