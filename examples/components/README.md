...
- Custom component assignments for each target
- Shared export configuration between related targets
- Component validation setup
- Selective installation based on component filters
