...
std::string Library::getName() {
    return CONFIG_LIB_NAME;
}

std::string Library::getVersion() {
    return CONFIG_LIB_VERSION_STRING;
}

std::string Library::getDescription() {
    return CONFIG_LIB_DESCRIPTION;
}

std::string Library::getAuthor() {
    return CONFIG_LIB_AUTHOR;
}
